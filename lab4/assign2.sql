...
hpid INT REFERENCES hero(pid),
bname VARCHAR2(30) REFERENCES backpack(bname),
qname VARCHAR2(30) REFERENCES quest(qname));

CREATE TABLE area
(aname VARCHAR2(30) PRIMARY KEY,
...
mlevel INT NOT NULL,
aname VARCHAR2(30) REFERENCES area(aname));

CREATE TABLE fights
(hpid INT REFERENCES hero(pid),
mname VARCHAR2(30) REFERENCES monster(mname));
