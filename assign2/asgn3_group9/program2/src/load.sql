...
CREATE TABLE quest
(qname VARCHAR2(31) PRIMARY KEY,
mandatory INT NOT NULL,
qtype VARCHAR2(31) NOT NULL,
difficulty VARCHAR2(31) NOT NULL);
...
CREATE TABLE area
(aname VARCHAR2(31) PRIMARY KEY,
asize NUMBER(10,2) NOT NULL,
restricted INT NOT NULL);


CREATE TABLE monster
(mname VARCHAR2(31) PRIMARY KEY,
mlevel INT NOT NULL,
aname VARCHAR2(31) NOT NULL);


CREATE TABLE MHP(
mlevel INT PRIMARY KEY,
mhp INT NOT NULL
);
...
damageP INT,
VALUE INT NOT NULL,
PRIMARY KEY(rarity,damageM,damageP)
);


CREATE TABLE fights(
hpid INT REFERENCES hero(pid),
mname VARCHAR2(31) REFERENCES monster(mname),
PRIMARY KEY(hpid,mname));


CREATE TABLE embarks_on(
hpid INT REFERENCES hero(pid),
qname VARCHAR2(31) REFERENCES quest(qname),
PRIMARY KEY(hpid,qname));


CREATE TABLE takes_place_in(
aname VARCHAR2(31) REFERENCES area(aname),
qname VARCHAR2(31) REFERENCES quest(qname),
PRIMARY KEY(aname, qname));

CREATE TABLE weapon
(wid INT PRIMARY KEY,
wname VARCHAR2(31) NOT NULL,
pdamage INT NOT NULL ,
mdamage INT NOT NULL ,
rarity varchar2(15) NOT NULL,
hpid INT NOT NULL,
bname VARCHAR2(31) NOT NULL,
qname VARCHAR2(31) NOT NULL REFERENCES quest(qname) );

ALTER TABLE weapon ADD CONSTRAINT FK_COMPOSITE FOREIGN KEY (hpid,bname) REFERENCES backpack(hpid,bname);

@trigger.sql

INSERT INTO hero VALUES (1, 'Barbarian', TO_DATE('01-12-2016','DD-MM-YYYY'), 10000);
INSERT INTO hero VALUES (2, 'DemonHunter', TO_DATE('02-11-2015','DD-MM-YYYY'), 1000);
INSERT INTO hero VALUES (3, 'Monk', TO_DATE('03-10-2014','DD-MM-YYYY'), 999);
INSERT INTO hero VALUES (4, 'WitchDoctor', TO_DATE('04-09-2013','DD-MM-YYYY'), 100);
...
INSERT INTO backpack VALUES ('testPack', 3, 20, 3000);
INSERT INTO backpack VALUES ('testPack1', 4, 20, 3000);
...
INSERT INTO weapon VALUES (4, 'Holy Hammer', 10, 350, 'Unique', 4, 'WDDeadPack', 'Create a country');
INSERT INTO weapon VALUES (5, 'Andariels Visage', 200, 16, 'Rare',1,'BarPickPack' ,'Recruit the Farmers');
INSERT INTO weapon VALUES (6, 'Dead Mans Legacy', 10, 300, 'Unique', 2, 'DMFoodPack' ,'Create a country');
INSERT INTO weapon VALUES (7, 'Chantodos Force', 200, 20, 'Rare', 3, 'MonkPoisonPack' ,'The human should be killed');
INSERT INTO weapon VALUES (8, 'Weight of the Earth', 15, 300, 'Unique', 4, 'WDHeadPack' ,'Create a country');
insert into weapon VALUES(9999,'TestBlade',9999,9999,'Common',2,'DMWeaponPack','Slay the Eternal Dragon');
